		    ...
		    Begin
				...
				Update MaterialInfo
					Set MaterialInfo.ConvertedDate = MaterialInfo.MaterialDate, 
						...
						ConvertedCost = 
							Case
								When	IsNull(MaterialInfo.CostUnitName, '') Not In ('$//YD^3', '$/CY','CY', 'GA', 'GL', '$/GL', '$/gal', 'OZ', '$/oz', '$/TN', 'TN', '$/Ton', '$/LB', 'LB', '$/lb', 'TON', 'ml', 'Ml-liter', 'Liter', 'Liters', 'Litres', '$/liter', 'KG', '$/Kg', 'LT', 'L', 'LL', 'TM', 'MT', '$/MTon', 'Pounds', 'Fluid Oz', 'Gallons') Or 
								...
								When IsNull(MaterialInfo.CostUnitName, '') In ('TN', '$/Ton', 'TON', '$/TN')
