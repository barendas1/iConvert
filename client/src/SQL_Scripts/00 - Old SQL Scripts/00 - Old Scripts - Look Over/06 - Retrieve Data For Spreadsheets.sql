...
Left Join Data_Import_RJ.dbo.TestImport0000_Plant As PlantInfo
...
Left Join Data_Import_RJ.dbo.TestImport0000_ItemType As ItemType
...
Where   MixInfo.AutoID In
        (
        	...
        	From Data_Import_RJ.dbo.TestImport0000_Mix As MixInfo2
