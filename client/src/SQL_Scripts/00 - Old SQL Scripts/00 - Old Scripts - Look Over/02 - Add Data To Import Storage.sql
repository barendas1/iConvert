...
Insert into @LocationXML (XMLInfo)
	...
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230710_1730 O&G Import Files\Locations.XML', Single_blob) As XMLInfo

Set @LocationXMLDocument = (Select XMLInfo From @LocationXML)

Insert into Data_Import_RJ.dbo.TestImport0000_Location (LocationID, Code, Name, ShortName, DivisionName)
...
Left Join Data_Import_RJ.dbo.TestImport0000_Location As ExistingLocation
...
Insert into @PlantXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230710_1730 O&G Import Files\Plants.XML', Single_blob) As XMLInfo

Set @PlantXMLDocument = (Select XMLInfo From @PlantXML)

Insert into Data_Import_RJ.dbo.TestImport0000_Plant (PlantID, Code, [Description], ShortDescription, LocationID, LocationCode, MaxBatchSize, MaxBatchSizeUnitName)
Select  Data.Col.value('ID[1]', 'Int') As PlantID,
        LTrim(RTrim(Replace(Data.Col.value('Code[1]', 'NVarChar(255)'), Char(160), ' '))) As Code,
...
Left Join Data_Import_RJ.dbo.TestImport0000_Plant As ExistingPlant
...
Insert into @ItemCategoryXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230710_1730 O&G Import Files\ItemCategories.XML', Single_blob) As XMLInfo

Set @ItemCategoryXMLDocument = (Select XMLInfo From @ItemCategoryXML)

Insert into Data_Import_RJ.dbo.TestImport0000_ItemCategory (ItemCategoryID, Code, [Description], ShortDescription, ItemTypeID, ItemTypeName)
...
Left Join Data_Import_RJ.dbo.TestImport0000_ItemCategory As ExistingCategory
...
Insert into @ItemTypeXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230710_1730 O&G Import Files\ItemTypes.XML', Single_blob) As XMLInfo

Set @ItemTypeXMLDocument = (Select XMLInfo From @ItemTypeXML)

Insert into Data_Import_RJ.dbo.TestImport0000_ItemType (ItemTypeID, Name, [Description])
...
Left Join Data_Import_RJ.dbo.TestImport0000_ItemType As ExistingItemType
...
Insert into @MaterialXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230710_1730 O&G Import Files\Materials.XML', Single_blob) As XMLInfo

Set @MaterialXMLDocument = (Select XMLInfo From @MaterialXML)

Insert into Data_Import_RJ.dbo.TestImport0000_Material
(
...
Left Join Data_Import_RJ.dbo.TestImport0000_Material As ExistingMaterial
...
Insert into @MixXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230710_1730 O&G Import Files\Mixes.XML', Single_blob) As XMLInfo

Set @MixXMLDocument = (Select XMLInfo From @MixXML)

Insert into Data_Import_RJ.dbo.TestImport0000_Mix
(
