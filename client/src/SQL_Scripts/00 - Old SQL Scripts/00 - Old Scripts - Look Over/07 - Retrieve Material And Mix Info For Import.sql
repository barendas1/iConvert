...
From Data_Import_RJ.dbo.TestImport0000_ItemCategory As ItemCategory
...
Left Join Data_Import_RJ.dbo.TestImport0000_MaterialInfo As ExistingMaterial
...
From Data_Import_RJ.dbo.TestImport0000_Mix As MixData
