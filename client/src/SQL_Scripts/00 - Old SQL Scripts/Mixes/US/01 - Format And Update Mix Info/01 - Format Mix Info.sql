        ...
        */
		...
		Update MixInfo
			Set MixInfo.MinAirContent = 
		        ...
		        MixInfo.Strength =
		            Case
		                When Round(Isnull(MixInfo.Strength, -1.0), 4) <= 0.0
		                Then Null
		...
		Update MixInfo
			Set MixInfo.StrengthAge =
		            Case
		                When Round(Isnull(MixInfo.StrengthAge, -1.0), 4) <= 0.0 And Round(Isnull(MixInfo.Strength, -1.0), 4) >= 0.01
		                Then 28.0
		                When Round(Isnull(MixInfo.StrengthAge, -1.0), 4) <= 0.0 Or Round(Isnull(MixInfo.Strength, -1.0), 4) <= 0.0
		                Then Null
