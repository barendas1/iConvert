...
Begin    
	...
	Declare @MixReportInfo Table 
	(
		MixID Int Index IX_MixReportInfo_MixID, 
		MixSpecID Int Index IX_MixReportInfo_MixSpecID, 
    ...
    Begin try
		...
		Begin
		    ...
		    Begin
		        ...
		        From #MixRecipeInfo As MixRecipeInfo
		        Where MixRecipeInfo.QuantityUnit In ('L', 'LT', 'LI')
		        ...
		        From #MixRecipeInfo As MixRecipeInfo
		        Where MixRecipeInfo.QuantityUnit In ('ML')
