Declare @CheckForMixExistence Bit = 0
...
Select  MixRecipe.PlantCode As [Plant Name],
		...
		End As [Status Message],
		Case
			When Isnull(MixRecipe.QuantityUnitName, '') Not In ('OZ/CWT', 'CY', 'lb', 'ga', 'oz', 'Fluid Oz', 'L', 'LT', 'KG', 'ML', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'Cubic Yards', 'EA', 'Each', 'CC', 'GR')
...
Where	IsNull(MixRecipe.MaterialItemCode, '') = '' Or
		...
		Isnull(MixRecipe.QuantityUnitName, '') Not In ('OZ/CWT', 'lb', 'ga', 'oz', 'Fluid Oz', 'L', 'LT', 'KG', 'ML', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'CY', 'Cubic Yards', 'EA', 'Each', 'CC', 'GR')
