...
Begin
    ...
    Begin try
		...
		Begin
		    If Exists(Select * From Data_Import_RJ.sys.objects As Objects Where Objects.name = 'Import17_ItemCategory')		    
		    Begin
		    	Print ''
		    	...
		    	Select	Ltrim(Rtrim(ItemCategoryInfo.Name)), 
		    			Ltrim(Rtrim(ItemCategoryInfo.[Description])),
		    	      	...
		    	      	Ltrim(Rtrim(ItemCategoryInfo.ItemCategoryType))
		    	From Data_Import_RJ.dbo.Import17_ItemCategory As ItemCategoryInfo		    	
		    	...
		    	On	Ltrim(Rtrim(ItemCategoryInfo.Name)) = Ltrim(Rtrim(ExistingItemCategory.ItemCategory)) And
		    		Ltrim(Rtrim(ItemCategoryInfo.ItemCategoryType)) = Ltrim(Rtrim(ExistingItemCategory.ProdItemCatType))
		    	Where	ExistingItemCategory.ProdItemCatID Is Null And
		    			...
		    			(
		    				...
		    				Where	Ltrim(Rtrim(Isnull(ItemCategoryInfo.Name, ''))) <> '' And
		    						LTrim(RTrim(IsNull(ItemCategoryInfo.ItemCategoryType, ''))) In ('Mix', 'Mtrl', 'MtrlCompType')
		    				Group By Ltrim(Rtrim(ItemCategoryInfo.ItemCategoryType)), Ltrim(Rtrim(ItemCategoryInfo.Name))	    	
		    			)
    ...
    Begin try
		...
		Begin
		    ...
		    Begin
		        ...
		        Where MixRecipeInfo.QuantityUnit = 'LB'
		        ...
		        From #MixRecipeInfo As MixRecipeInfo
		        Where MixRecipeInfo.QuantityUnit = 'OZ'
		        ...
		        From #MixRecipeInfo As MixRecipeInfo
		        Where MixRecipeInfo.QuantityUnit In ('GL', 'GA')
