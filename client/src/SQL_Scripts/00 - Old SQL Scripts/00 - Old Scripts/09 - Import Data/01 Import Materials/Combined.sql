		    ...
		    Begin
				...
				Update MaterialInfo
					Set MaterialInfo.ConvertedDate = MaterialInfo.MaterialDate, 
						...
						ConvertedCost = 
							Case
								When	IsNull(MaterialInfo.CostUnitName, '') Not In ('CY', 'GL', '$/gal', 'OZ', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'Liter', 'Liters', 'Litres', 'KG', 'LT', 'L', 'LL', 'TM') Or 
								...
								When IsNull(MaterialInfo.CostUnitName, '') In ('Liter', 'Liters', 'Litres', 'LT', 'L', 'LL')
								Then MaterialInfo.Cost * 1000.0 / (MaterialInfo.SpecificGravity * 1.0)
								When IsNull(MaterialInfo.CostUnitName, '') In ('KG')
								Then MaterialInfo.Cost * 1000.0
								When IsNull(MaterialInfo.CostUnitName, '') In ('TM')
...
Begin
	...
	Begin Try
		...
		Begin
			...
			Exec dbo.MaterialImport_ImportMaterials 1, 5
		End
