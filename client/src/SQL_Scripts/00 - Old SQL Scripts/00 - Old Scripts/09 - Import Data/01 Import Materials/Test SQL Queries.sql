...
Inner Join Data_Import_RJ.dbo.TestImport0000_MixInfo As ImportInfo
...
Where	ImportInfo.AutoID In
		(
			...
			From Data_Import_RJ.dbo.TestImport0000_MixInfo As ImportInfo
