		    ...
		    Begin
				...
				Update MaterialInfo
					Set MaterialInfo.ConvertedDate = MaterialInfo.MaterialDate, 
						...
						ConvertedCost = 
							Case
								When	IsNull(MaterialInfo.CostUnitName, '') Not In ('CY', 'GA', 'GL', '$/GL', '$/gal', 'OZ', '$/oz', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'ml', 'Ml-liter', 'Liter', 'Liters', 'Litres', '$/liter', 'KG', '$/Kg', 'LT', 'L', 'LL', 'TM', 'MT', '$/MTon', 'Pounds', 'Fluid Oz', 'Gallons') Or 
