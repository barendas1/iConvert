...
Select	MaterialInfo.*,		
		...
		Case
			When MaterialInfo.Cost Is Null Or  MaterialInfo.CostUnitName Not In ('oz', '$/oz', 'GA', '$/GL', '$/gal', '$/lb', 'LB', '$/ton', '$/Kg', '$/MTon', 'Liters', '$/Liter', 'Ml-liter', 'ml')
			Then -1.0
			When MaterialInfo.CostUnitName In ('GA', '$/gal', '$/GL')
			...
			When MaterialInfo.CostUnitName In ('$/ton')
...
Where	--IsNull(Cast(Material.DATE As Datetime), -1.0) <> Isnull(Cast(MaterialInfo.MaterialDate As Datetime), -1.0) Or
		...
		Case
			When MaterialInfo.Cost Is Null Or MaterialInfo.CostUnitName Not In ('oz', '$/oz', 'lb', 'TN', 'GA', '$/GL', '$/gal', '$/lb', '$/ton', '$/Kg', 'Kg', '$/MTon', 'ml', 'Ml-liter', 'Liters', '$/Liter', 'MT', 'L', 'Gallons', 'Pounds', 'Fluid Oz')
			Then -1.0
			When MaterialInfo.CostUnitName In ('$/gal', 'Gallons', 'GA', '$/GL')
			Then Round(MaterialInfo.Cost * 264.17205 / (MaterialInfo.SpecificGravity * 1.0), 6)
			When IsNull(MaterialInfo.CostUnitName, '') In ('OZ', 'Fluid Oz', '$/oz')
			Then Round(MaterialInfo.Cost * 128.0 * 264.17205 / (MaterialInfo.SpecificGravity * 1.0), 6)
