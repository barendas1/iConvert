...
If dbo.Validation_TemporaryTableExists('#ItemCategory') = 1
Begin
    Drop table #ItemCategory
End

If dbo.Validation_TemporaryTableExists('#Plant') = 1
Begin
    Drop table #Plant
End

If dbo.Validation_TemporaryTableExists('#Mix') = 1
Begin
    Drop table #Mix
End

If dbo.Validation_TemporaryTableExists('#Material') = 1
Begin
    Drop table #Material
End

If dbo.Validation_TemporaryTableExists('#MixRecipe') = 1
Begin
    Drop table #MixRecipe
End

If dbo.Validation_TemporaryTableExists('#NewMixNameCodes') = 1
Begin
    Drop table #NewMixNameCodes
End

If dbo.Validation_TemporaryTableExists('#MixNameCodes') = 1
Begin
    Drop table #MixNameCodes
End

If dbo.Validation_TemporaryTableExists('#NewMixCodes') = 1
Begin
    Drop table #NewMixCodes
End
...
Create Table #NewMixNameCodes
(
    CodeNumber      Int,
    MixNameCode     Nvarchar(100)
) 

Create Table #MixNameCodes
(
    AutoID          Int Identity(1, 1),
    MixNameCode     Nvarchar(100)
)
Create Table #NewMixCodes
(
    ID          Int,
    MixCode     Nvarchar(50)
)
...
Print ''
Print 'Get Mix and Material Item Categories'
...
Select  Ltrim(Rtrim(ICAT.ITEM_CAT)),
        ...
        Ltrim(Rtrim(ICAT.ITEM_TYPE)),
        'Mix'
    From [Command_Subset_RJ].dbo.ICAT As ICAT
    Inner Join [Command_Subset_RJ].dbo.IMST As IMST
    On  IMST.ITEM_CAT = ICAT.ITEM_CAT
    Inner Join [Command_Subset_RJ].dbo.ICST As ICST
...
Update #ItemCategory
    Set [Type] = 'Mix'
	Where [Type] Is Null And ItemType In ('01')

Update #ItemCategory
    Set [Type] = 'Mtrl'
	Where [Type] Is Null And ItemType Not In ('01')
/*
Select * 
From #ItemCategory
...
Print ''
Print 'Set Up Material Properties of Material Item Categories'
...
Select  Ltrim(Rtrim(Iloc.LOC_CODE)),
    ...
    From [Command_Subset_RJ].dbo.IMST As IMST
    Inner Join [Command_Subset_RJ].dbo.ILOC As ILOC
...
Print ''
Print 'Get Material Information'
...
Print ''
Print 'Get Mix Recipe Information'
...
Select  Ltrim(Rtrim(ICST.LOC_CODE)),
    ...
    From [Command_Subset_RJ].dbo.ICST As ICST
...
Print ''
Print 'Add the Mix and Material Item Categories'
...
Print ''
Print 'Add Mix and Material Names'
...
Print ''
Print 'Add Mix and Material Item Descriptions'
...
Print ''
Print 'Add Item Master Information for Mixes and Materials'
...
Print ''
Print 'Create New Mix Name Codes'
...
Print ''
Print 'Update the Mix Name Codes and Mix Codes of the Mixes'
...
Print ''
Print 'Update Mix Recipe Values With Units - 60003'
...
Print ''
Print 'Update Mix Recipe Values With Units - 60002'
...
Print ''
Print 'Update Mix Recipe Values With Units - 50001'
...
Print ''
Print 'Update Mix Recipe Values With Units - 50004'
...
Print ''
Print 'Update Mix Recipe Values With Units - 60013'
...
Print ''
Print 'Update Mix Recipe Values With Units - 60012'
...
Print ''
Print 'Update Mix Recipe Values With Units - 50012'
...
Print ''
Print 'Update Mix Recipe Values With Units - 50011'
...
Print ''
Print 'Update Mix Recipe Values With No Units'
...
Print ''
Print 'Add Mix Recipe Information'
...
Print ''
Print 'Update Mix Sack Contents'
