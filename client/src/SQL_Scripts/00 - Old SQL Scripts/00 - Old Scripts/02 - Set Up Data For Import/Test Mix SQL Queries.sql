...
Select *
From Data_Import_RJ.dbo.TestImport0000_MixItemCategory As CategoryInfo
...
Select *
From CmdTest_RJ.dbo.uoms As MeasInfo

Select ICST.*
From CmdTest_RJ.dbo.ICST As ICST
Left Join CmdTest_RJ.dbo.iloc As ILOC
