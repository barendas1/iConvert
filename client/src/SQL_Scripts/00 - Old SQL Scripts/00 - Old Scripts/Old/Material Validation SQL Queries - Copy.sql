...
Select	MaterialInfo.PlantName As [Plant Name],
		...
		Case
			When	Isnull(MaterialInfo.Cost, -1.0) >= 0.0 And
					Isnull(MaterialInfo.CostUnitName, '') Not In ('$/LB', 'Pounds', 'Fluid Oz', 'Gallons', 'Ounces', 'm3', '$/CY', 'CY', '$//YD^3', 'GA', '$/GL', 'GL', '$/gal', 'OZ', '$/oz', '$/TN', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'Ml-liter', 'ml', 'Liter', 'Liters', 'Litres', '$/liter', 'LT', 'L', 'LL', 'KG', '$/Kg', 'TM', 'MT', '$/Metric Ton', '$/MTon')
...
Where	Isnull(MaterialInfo.PlantName, '') = '' Or
		...
		Isnull(MaterialInfo.CostUnitName, '') Not In ('$/LB', 'Pounds', 'Fluid Oz', 'Gallons', 'Ounces','m3', '$/CY', 'CY', '$//YD^3', 'GA', 'GL', '$/GL', '$/gal', 'OZ', '$/OZ', '$/TN', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'Ml-liter', 'ml', 'Liter', 'Liters', 'Litres', '$/Liter', 'LT', 'L', 'LL', 'KG', '$/Kg', 'TM', 'MT', '$/Metric Ton', '$/MTon', 'Pounds', 'Fluid Oz', 'Gallons') Or
