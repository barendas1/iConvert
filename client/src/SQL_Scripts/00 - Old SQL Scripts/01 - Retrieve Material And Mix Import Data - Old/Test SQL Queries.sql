...
From dbo.TestImport0000_XML_ItemCategory As Info
Order By Info.AutoID

Select 'Item Type' As [Type], * 
From dbo.TestImport0000_XML_ItemType As Info
Order By Info.AutoID

Select 'Location' As [Type], * 
From dbo.TestImport0000_XML_Location As Info
Order By Info.AutoID

Select 'Material' As [Type], * 
From dbo.TestImport0000_XML_Material As Info
Order By Info.AutoID

Select 'Mix' As [Type], * 
From dbo.TestImport0000_XML_Mix As Info
Order By Info.AutoID

Select 'Plant' As [Type], * 
From dbo.TestImport0000_XML_Plant As Info
Order By Info.AutoID
...
Select *
From Data_Import_RJ.dbo.TestImport0000_XML_ItemCategory As Info
Order By Info.Code
...
Left Join Data_Import_RJ.dbo.TestImport0000_XML_Location As LocationInfo
...
Select  MaterialInfo.PlantID As [Location ID],
        ...
        MaterialInfo.SpecificGravity As [Specific Gravity],
        MaterialInfo.Cost As [Cost],
        MaterialInfo.PurchaseUnit As [Purchase Unit Name],
        MaterialInfo.Price As [Price],
        MaterialInfo.PriceQuantityUnit [Price Unit Name],
        MaterialInfo.ItemCategoryCode As [Item Category],
        MaterialInfo.ItemTypeName As [Item Type]
From Data_Import_RJ.dbo.TestImport0000_XML_Material As MaterialInfo
Order By MaterialInfo.PlantCode, MaterialInfo.ItemCode
