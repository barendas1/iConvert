...
Inner Join CmdProd_Sonag_RJ.dbo.imst As IMST
...
Select *
From CmdProd_Sonag_RJ.dbo.locn As LOCN

Select Top 1000 *
From CmdProd_Sonag_RJ.dbo.tick

Select UOMS.descr
From CmdProd_Sonag_RJ.dbo.twgt As TWGT
Inner Join CmdProd_Sonag_RJ.dbo.UOMS As UOMS
...
From CmdProd_Sonag_RJ.dbo.iloc As ILOC
...
Select *
From CmdProd_Sonag_RJ.dbo.IMLB
...
Left Join CmdProd_SONAG_RJ.dbo.imlb As IMLB
