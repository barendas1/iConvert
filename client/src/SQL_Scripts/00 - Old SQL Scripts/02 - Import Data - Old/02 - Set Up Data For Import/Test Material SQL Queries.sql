...
Select *
From CmdProd_SONAG_RJ.dbo.uoms As UOMS
...
Select MtrlInfo1.*
From Data_Import_RJ.dbo.TestImport0000_XML_MainMaterialInfo As MtrlInfo1
...
Select *
From Data_Import_RJ.dbo.TestImport0000_XML_MainMaterialInfo As Info
