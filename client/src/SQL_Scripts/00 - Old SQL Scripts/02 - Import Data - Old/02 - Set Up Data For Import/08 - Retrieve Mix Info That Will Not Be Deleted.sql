...
Begin
    If	Exists (Select * From Data_Import_RJ.sys.objects Where Name = 'TestImport0000_XML_MixInfoNotDeleted') And
		Exists (Select * From Data_Import_RJ.sys.objects Where Name = 'TestImport0000_XML_MixInfo') 
    Begin
    	Insert into Data_Import_RJ.dbo.TestImport0000_XML_MixInfoNotDeleted
    	(
    		PlantCode,
    		MixCode,
    		MixID
    	...
    	Left Join Data_Import_RJ.dbo.TestImport0000_XML_MixInfoNotDeleted As MixInfo
