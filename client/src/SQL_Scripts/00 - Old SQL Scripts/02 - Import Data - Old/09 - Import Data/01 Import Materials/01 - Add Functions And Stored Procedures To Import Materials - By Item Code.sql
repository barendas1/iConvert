...
Begin
    ...
    Begin try
		...
		Begin
		    If Exists(Select * From Data_Import_RJ.sys.objects As Objects Where Objects.name = 'TestImport0000_XML_MaterialItemCategory')		    
		    Begin
		    	Print ''
		    	...
		    	From Data_Import_RJ.dbo.TestImport0000_XML_MaterialItemCategory As ItemCategoryInfo		    	
		    ...
		    Begin
				...
				Update MaterialInfo
					Set MaterialInfo.ConvertedDate = MaterialInfo.MaterialDate, 
						...
						ConvertedCost = 
							Case
								When	IsNull(MaterialInfo.CostUnitName, '') Not In ('CY', 'GA', 'GL', '$/gal', 'OZ', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'ml', 'Ml-liter', 'Liter', 'Liters', 'Litres', '$/liter', 'KG', '$/Kg', 'LT', 'L', 'LL', 'TM', 'MT', '$/MTon', 'Pounds', 'Fluid Oz', 'Gallons') Or 
								...
								When IsNull(MaterialInfo.CostUnitName, '') In ('GA', 'GL', '$/gal', 'Gallons')
								...
								When IsNull(MaterialInfo.CostUnitName, '') In ('LB', '$/lb', 'Pounds')
