...
Begin
    ...
    Begin try
		...
		Begin
		    If Exists(Select * From Data_Import_RJ.sys.objects As Objects Where Objects.name = 'ImportProd02_MaterialItemCategory')		    
		    Begin
		    	Print ''
		    	...
		    	From Data_Import_RJ.dbo.ImportProd02_MaterialItemCategory As ItemCategoryInfo		    	
...
Begin
    ...
    Begin try
		...
		If Exists (Select * From Sys.databases As Databases Where Databases.name = 'Data_Import_RJ')
		Begin
		    If Exists(Select * From Data_Import_RJ.sys.objects Where Name = 'ImportProd02_MaterialInfo')
		    Begin
		        ...
		        From Data_Import_RJ.dbo.ImportProd02_MaterialInfo As MaterialInfo
				...
				(
					...
					NonBatchable,
					BatchingOrder,
					OnlyAllowedInImportedBatchRecipes
				)
