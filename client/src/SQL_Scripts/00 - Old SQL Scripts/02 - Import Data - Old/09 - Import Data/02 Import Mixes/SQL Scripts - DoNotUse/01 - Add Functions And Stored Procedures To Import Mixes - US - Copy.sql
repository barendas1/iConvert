...
Begin
    ...
    Begin try
		...
		Begin
		    If Exists(Select * From Data_Import_RJ.sys.objects As Objects Where Objects.name = 'ImportProd05_MixItemCategory')		    
		    Begin
		    	Print ''
		    	...
		    	From Data_Import_RJ.dbo.ImportProd05_MixItemCategory As ItemCategoryInfo		    	
...
Begin
    ...
    Begin try
		...
		If Exists (Select * From Sys.databases As Databases Where Databases.name = 'Data_Import_RJ')
		Begin
		    If	Exists(Select * From Data_Import_RJ.sys.objects Where Name = 'ImportProd05_MixInfo')
		    Begin
				...
				From Data_Import_RJ.dbo.ImportProd05_MixInfo As MixInfo
				...
				Where	MixInfo.AutoID In
						(
							...
							(
								...
								From Data_Import_RJ.dbo.ImportProd05_MixInfo As MixRecipe
								Inner Join #MaterialInfo As MaterialInfo
							...
							Where	IsNull(MixInfo.MixCode, '') <> '' And									
									Mix.BATCHIDENTIFIER Is Null And
				...
				Inner Join Data_Import_RJ.dbo.ImportProd05_MixInfo As MixRecipe
