...
Select  MixRecipe.PlantCode As [Plant Name],
		...
		End As [Status Message],
		Case
			When Isnull(MixRecipe.QuantityUnitName, '') Not In ('lb', 'ga', 'oz', 'L', 'LT', 'KG', 'ML', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'Cubic Yards', 'Each', 'CC', 'GR')
			Then 'The Mix Recipe Quantity Units is not one of the following: lb, ga, oz, l, lt, kg, ml, GAL, LQ OZ, ounces, oz/cwt CM, pounds, gallons, Cubic Yards, Each, CC, GR'
			Else ''
		End As [Status Message]
...
Where	IsNull(MixRecipe.MaterialItemCode, '') = '' Or
		...
		Isnull(MixRecipe.QuantityUnitName, '') Not In ('lb', 'ga', 'oz', 'L', 'LT', 'KG', 'ML', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'Cubic Yards', 'Each', 'CC', 'GR')
