...
Select  MixRecipe.PlantCode As [Plant Name],
		...
		End As [Status Message],
		Case
			When Isnull(MixRecipe.QuantityUnitName, '') Not In ('lb', 'ga', 'oz', 'Fluid Oz', 'L', 'LT', 'Liters', 'KG', 'ML','Ml-liter', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'Cubic Yards', 'Each', 'CC', 'GR')
...
Where	IsNull(MixRecipe.MaterialItemCode, '') = '' Or
		...
		Isnull(MixRecipe.QuantityUnitName, '') Not In ('lb', 'ga', 'oz', 'Fluid Oz', 'L', 'LT', 'Liters', 'KG', 'ML', 'Ml-liter', 'GAL', 'GL', 'LQ OZ', 'Ounces', 'oz/cwt CM', 'Pounds', 'Gallons', 'Cubic Yards', 'Each', 'CC', 'GR')
