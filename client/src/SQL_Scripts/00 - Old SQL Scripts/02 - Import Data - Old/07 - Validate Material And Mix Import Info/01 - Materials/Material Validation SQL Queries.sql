...
Select	MaterialInfo.PlantName As [Plant Name],
		...
		Case
			When	Isnull(MaterialInfo.Cost, -1.0) >= 0.0 And
					Isnull(MaterialInfo.CostUnitName, '') Not In ('Pounds', 'Fluid Oz', 'Gallons', 'Ounces', 'm3', 'CY','GA', 'GL', '$/gal', 'OZ', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'Ml-liter', 'ml', 'Liter', 'Liters', 'Litres', '$/liter', 'LT', 'L', 'LL', 'KG', '$/Kg', 'TM', 'MT', '$/Metric Ton', '$/MTon')
...
Where	Isnull(MaterialInfo.PlantName, '') = '' Or
		...
		Isnull(MaterialInfo.CostUnitName, '') Not In ('Pounds', 'Fluid Oz', 'Gallons', 'Ounces','m3', 'CY','GA', 'GL', '$/gal', 'OZ', 'TN', '$/Ton', 'LB', '$/lb', 'TON', 'Ml-liter', 'ml', 'Liter', 'Liters', 'Litres', '$/Liter', 'LT', 'L', 'LL', 'KG', '$/Kg', 'TM', 'MT', '$/Metric Ton', '$/MTon', 'Pounds', 'Fluid Oz', 'Gallons') Or
...
From Data_Import_RJ.dbo.TestImport0000_XML_MaterialInfo As MaterialInfo1
Left Join Data_Import_RJ.dbo.TestImport0000_XML_MaterialInfo As MaterialInfo2
