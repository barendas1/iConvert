...
If Exists (Select * From Sys.databases Where Name = 'Data_Import_RJ')
Begin
    If	Exists (Select * From Data_Import_RJ.sys.objects Where Name = 'TestImport0000_MainMaterialInfo') And
    ...
    Begin
    	...
    	From Data_Import_RJ.dbo.TestImport0000_MainMaterialInfo As MainMtrlInfo
