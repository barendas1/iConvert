Insert into Data_Import_RJ.dbo.TestImport0000_XML_MixItemCategory (Name, [Description], ShortDescription, CategoryNumber, CategoryType)
...
Insert into Data_Import_RJ.dbo.TestImport0000_XML_MaterialItemCategory (Name, [Description], ShortDescription, CategoryNumber, CategoryType)
Select ItemCategory.Code, ItemCategory.[Description],
       ItemCategory.ShortDescription, Cast(ItemCategory.ItemTypeID As Nvarchar), 'Mtrl'
From Data_Import_RJ.dbo.TestImport0000_XML_ItemCategory As ItemCategory
Left Join Data_Import_RJ.dbo.TestImport0000_XML_MaterialItemCategory As MaterialCategory
On ItemCategory.Code = MaterialCategory.Name
Where   ItemCategory.ItemTypeID <> 1 And 
        MaterialCategory.AutoID Is Null And
        ItemCategory.Code Not In ('90', '91', '94') --'88', 
Order By ItemCategory.Code
...
(
	...
	From Data_Import_RJ.dbo.TestImport0000_XML_MixInfo As MixInfo2
