Declare @XMLFilePath Nvarchar (600) = '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\'
...
Insert into @LocationXML (XMLInfo)
	...
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\Locations.XML', Single_blob) As XMLInfo
...
Insert into @PlantXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\Plants.XML', Single_blob) As XMLInfo
...
Insert into @ItemCategoryXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\ItemCategories.XML', Single_blob) As XMLInfo
...
Insert into @ItemTypeXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\ItemTypes.XML', Single_blob) As XMLInfo
...
Insert into @MaterialXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\Materials.XML', Single_blob) As XMLInfo
...
Insert into @MixXML (XMLInfo)
	Select Convert(Xml, BulkColumn) As BulkColumn 
	From Openrowset(Bulk '\\ThePhantom\E$\Documents\Projects\Year 2023\20230717_1752 O&G Import Files\Mixes.XML', Single_blob) As XMLInfo
