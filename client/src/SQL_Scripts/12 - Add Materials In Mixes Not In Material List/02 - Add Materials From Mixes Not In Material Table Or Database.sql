--> This SQL Script adds Materials to the Material List that are not in the Quadrel Database and that are not in the Material Table 
--> so that the Mixes might be able to be imported.
