...
(
	...
	Union All
	Select 'EXTRA CHARGE' As ItemCategoryName
	Union All
	Select 'OTHER' As ItemCategoryName
	Union All
	Select 'MINIMUM LOAD' As ItemCategoryName
	Union All
	Select 'PLANT CHARGE' As ItemCategoryName
	Union All
	Select 'SUNDRY CHARGE' As ItemCategoryName
	Union All
	Select 'TRUCK RENTAL' As ItemCategoryName
	Union All
	Select 'UNLOAD CHARGE' As ItemCategoryName
	Union All
