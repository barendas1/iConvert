    ...
    Begin
        ...
        */
        ...
        Select  Ltrim(Rtrim(Cast(Plant.Plant_ID As Nvarchar))) As PlantCode,
                ...
                Null /*Case when Round(Isnull(MixProduct.Price, -1.0), 4) > 0.0 And Isnull(MixUnitInfo.Imperial_Description, '') In ('CU Yards', 'm3', 'METRES') Then MixProduct.Price Else Null End*/ As MixPrice,
                Null /*Case when Isnull(MixUnitInfo.Imperial_Description, '') In ('CU Yards', 'm3', 'METRES') Then MixUnitInfo.Imperial_Description Else Null End*/ As MixPriceUnitName,
                Case When Isnull(MixProduct.Inactive_Flag, 0) = 1 Then 'Yes' Else 'No' End As MixInactive,
                '' As Padding,
